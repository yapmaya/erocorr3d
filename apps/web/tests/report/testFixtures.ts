...
//
// Rapor testlerinin ORTAK yardımcıları — GERÇEK referans tesis fixture'ından
// (packages/engine/src/fixtures/referenceFacility.ts), GERÇEK motor orkestrasyonuyla
...
// motorun GERÇEK çıktısını kullanır (bkz. referenceFacilityScenarios.ts'in AYNI deseni).

import { REFERENCE_FACILITY_FIXTURES, assessComponentScenario } from "@erocorr3d/engine";
...
export function buildTestAssessmentHistoryEntry(): AssessmentHistoryEntry {
  const fixture = REFERENCE_FACILITY_FIXTURES[0]!;
